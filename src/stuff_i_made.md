...
- [sk](https://github.com/packrat386/sk) - I write a lot of scripts
  that are worth saving to re-use but not worth their own repository.
  This is a tool to locally manage them. It was also a good excuse to
  learn how to do tab completion in bash.
- [atalanta](https://github.com/packrat386/atalanta) - I wondered what
...
- [catserver](https://github.com/packrat386/catserver) - I wrote, ran,
  ...
  GitHub.
- [thingdoer](https://github.com/packrat386/thingdoer) - Sometimes you
  want it to just do the thing.
- [nasT](https://github.com/kjcjohnson/nasT) - A collaboration with a
  friend at a hackathon. We attempted to build an MVC framework using
  only POSIX command line utilities.
